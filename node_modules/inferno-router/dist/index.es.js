...
function renderLink(classNm, children, otherProps) {
    return createVNode(2 /* HtmlElement */, "a", classNm, children, otherProps);
}
...
function IndexLink(props) {
    props.to = "/";
    return createVNode(8 /* ComponentFunction */, Link, null, null, props);
}
...
var Router = (function (Component$$1) {
    ...
    Router.prototype.render = function render (props) {
        ...
        return createVNode(4 /* ComponentClass */, RouterContext, null, null, {
...
export { IndexLink, Redirect as IndexRedirect, IndexRoute, Link, Redirect, Route, Router, RouterContext, createRoutes, doAllAsyncBefore, match };
