...
declare module 'inferno-router' {
    ...
    import doAllAsyncBefore from "inferno-router/doAllAsyncBefore";
    ...
    export { IndexLink, Redirect as IndexRedirect, IndexRoute, IPlainRouteConfig, Link, Redirect, Route, Router, RouterContext, VNode, createRoutes, doAllAsyncBefore, match };
    const _default: {
            ...
            doAllAsyncBefore: (renderProps: any) => Promise<boolean>;
...
declare module 'inferno-router/doAllAsyncBefore' {
    export default function doAllAsyncBefore(renderProps: any): Promise<boolean>;
}
